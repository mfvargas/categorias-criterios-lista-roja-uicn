...
Luego, debe ejecutarse abrirse y ejecutarse, con la interfaz de Jupyter, el _notebook_ llamado **categorias-criterios-lista-roja-uicn.ipynb**. Lea las instrucciones contenidas en el _notebook_.
