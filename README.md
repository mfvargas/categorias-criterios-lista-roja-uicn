...
Luego, debe ejecutarse abrirse y ejecutarse el _notebook_ llamado **categorias-criterios-lista-roja-uicn.ipynb** con la interfaz de Jupyter. Lea las instrucciones contenidas en el _notebook_.
